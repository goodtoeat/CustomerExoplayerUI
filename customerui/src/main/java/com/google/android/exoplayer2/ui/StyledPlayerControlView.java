...
public class StyledPlayerControlView extends FrameLayout {
  ...
  @Nullable private final TextView titleView;
  ...
  public StyledPlayerControlView(
    ...
    boolean showRewindButton = false;
    boolean showFastForwardButton = false;
...
//    controlViewLayoutManager.setShowButton(titleView, true);
  ...
  public void setTimeSkipPerDpadClick(int timeMs){
    timeBar.setKeyTimeIncrement(timeMs);
  }
